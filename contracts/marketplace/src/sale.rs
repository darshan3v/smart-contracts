...
impl Contract {
    ...
    pub fn offer(&mut self, nft_contract_id: AccountId, token_id: String) {
        ...
        self.process_purchase(contract_id, token_id, U128(deposit), buyer_id, None);
    }
    ...
    pub fn process_purchase(
        ...
        ext_contract::ext(nft_contract_id)
            ...
            .nft_transfer_payout(
                ...
                price,
                7, //the maximum amount of accounts the market can payout at once (this is limited by GAS)
            )
            .then(
    ...
    */
    ...
    pub fn resolve_purchase(
        ...
        //if the payout option was None, we refund the buyer for the price they payed and return
            ...
            // Check if ft token then refund ft token or refund near
